...
// -> When we call animalInfo(dog), the function prints the name of the animal as "Buddy" and the sound as "Woof". This is because dog is an instance of the Dog class, and the method makeSound() is called from the Animal superclass.

// -> When we call animalInfo(cat), the function prints the name of the animal as "Kitten" and the sound as "Meow". This is because cat is an instance of the Cat class, and the method makeSound() is called from the Animal superclass.
